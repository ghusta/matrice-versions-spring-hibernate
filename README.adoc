...
| [3.2-3.6]
|===
<1> Note : Voir https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/data-access.html#orm-hibernate
<2> Note : Hibernate 4.2 d'après le POM de _spring-orm_ 3.2.18
